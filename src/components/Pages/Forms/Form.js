          ...
          <div class="content-body">
            <div class="page-title mb-0">
              <div class="row mb-5">
                <div class="col-12">
                  <div class="d-block d-sm-flex align-items-center justify-content-between">
                    <h2 class="text-purple">Help us get to know you?</h2>
                    <div class="d-flex">
                      <div class="me-3">
                        <h6 class="fs-14 text-dark ff-helve fw-medium">
                          Form Status
                        </h6>
                        <h6 class="status pending ff-helve">Incomplete</h6>
                      </div>
                      <div>
                        <h6 class="fs-14 text-dark ff-helve fw-medium d-inline-block me-2">
                          Time Left:
                        </h6>
                        <h6 class="fs-16 text-purple ff-helve fw-bold d-inline-block">
                          (32:40:59)
                        </h6>
                      </div>
                    </div>
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">1:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
                    What is your business name
                  </h6>
                  <input
                    type="text"
                    class="form-control rounded-5 w-100"
                    value={q1}
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">2:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">3:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">4:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">5:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              {/* <div class="d-flex mb-4">
                ...
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3"></h6>
                  <input type="text" class="form-control rounded-5 w-100" />
                </div>
              </div> */}
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">6:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
                    Is there any particular service that you want us to promote?{" "}
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">7:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">8:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">9:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">10:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">11:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">12:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">13:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">14:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">15:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">16:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">17:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <div class="d-flex mb-4">
                <div class="me-3">
                  <h6 class="fs-20 text-orange fw-bold m-0">18:</h6>
                </div>
                <div class="flex-grow-1">
                  <h6 class="fs-16 text-dark fw-bold mb-3">
              ...
              <button class="btn btn-primary" onClick={onSubmitClick}>
                Submit
              </button>
            </div>
          </div>
